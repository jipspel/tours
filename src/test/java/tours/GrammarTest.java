...
public class GrammarTest {
    ...
    public void testValidAssignments() throws IOException {
        errorList = TestHelper.parseToursFile("src/test/java/tours/examples/typechecker/assignments_boolean.tours");
        assertEquals(0, errorList.size());

        errorList = TestHelper.parseToursFile("src/test/java/tours/examples/typechecker/assignments_compound.tours");
        assertEquals(0, errorList.size());

        errorList = TestHelper.parseToursFile("src/test/java/tours/examples/typechecker/assignments_character.tours");
        assertEquals(0, errorList.size());

        errorList = TestHelper.parseToursFile("src/test/java/tours/examples/typechecker/assignments_integer.tours");
        assertEquals(0, errorList.size());

        errorList = TestHelper.parseToursFile("src/test/java/tours/examples/typechecker/assignments_string.tours");
        assertEquals(0, errorList.size());
    ...
    public void testValidArrayAssignments() throws IOException {
        errorList = TestHelper.parseToursFile("src/test/java/tours/examples/typechecker/assignments_array_boolean.tours");
        assertEquals(0, errorList.size());

        errorList = TestHelper.parseToursFile("src/test/java/tours/examples/typechecker/assignments_array_character.tours");
        assertEquals(0, errorList.size());

        errorList = TestHelper.parseToursFile("src/test/java/tours/examples/typechecker/assignments_array_integer.tours");
        assertEquals(0, errorList.size());

        errorList = TestHelper.parseToursFile("src/test/java/tours/examples/typechecker/assignments_array_string.tours");
        assertEquals(0, errorList.size());

        errorList = TestHelper.parseToursFile("src/test/java/tours/examples/typechecker/functions_return_array_type.tours");
        assertEquals(0, errorList.size());
    ...
    public void testValidIfElseAssignments() throws IOException {
        errorList = TestHelper.parseToursFile("src/test/java/tours/examples/typechecker/assignments_if_else.tours");
        assertEquals(0, errorList.size());
    ...
    public void testValidExamples() throws IOException {
        errorList = TestHelper.parseToursFile("src/test/java/tours/examples/typechecker/array_length.tours");
        assertEquals(0, errorList.size());

        errorList = TestHelper.parseToursFile("src/test/java/tours/examples/typechecker/functions_arguments_primitive_type.tours");
        assertEquals(0, errorList.size());

        errorList = TestHelper.parseToursFile("src/test/java/tours/examples/typechecker/functions_arguments_array_type.tours");
        assertEquals(0, errorList.size());


        errorList = TestHelper.parseToursFile("src/test/java/tours/examples/typechecker/statement_for.tours");
        assertEquals(0, errorList.size());

        errorList = TestHelper.parseToursFile("src/test/java/tours/examples/typechecker/statement_if.tours");
        assertEquals(0, errorList.size());

        errorList = TestHelper.parseToursFile("src/test/java/tours/examples/typechecker/statement_while.tours");
        assertEquals(0, errorList.size());

        errorList = TestHelper.parseToursFile("src/test/java/tours/examples/typechecker/variable_declaration.tours");
        assertEquals(0, errorList.size());
    ...
    public void testMissingAssignment() throws IOException {
        errorList = TestHelper.parseToursFile("src/test/java/tours/examples/typechecker/invalid/missing_assignment.tours");
    ...
    public void testMissingSemicolon() throws IOException {
        errorList = TestHelper.parseToursFile("src/test/java/tours/examples/typechecker/invalid/missing_semicolon.tours");
        assertEquals(1, errorList.size());
    ...
    public void testMissingParenthesis() throws IOException {
        errorList = TestHelper.parseToursFile("src/test/java/tours/examples/typechecker/invalid/missing_parenthesis.tours");
        assertEquals(1, errorList.size());
    ...
    public void testInvalidFunctionReturns() throws IOException {
        errorList = TestHelper.parseToursFile("src/test/java/tours/examples/typechecker/invalid/function_returns.tours");
        assertEquals(1, errorList.size());
    ...
    public void testMissingElseInIfElseExpression() throws IOException {
        errorList = TestHelper.parseToursFile("src/test/java/tours/examples/typechecker/invalid/missing_else_in_if_else_expression.tours");
        assertEquals(1, errorList.size());
    ...
    public void testWhileAssignment() throws IOException {
        errorList = TestHelper.parseToursFile("src/test/java/tours/examples/typechecker/invalid/invalid_while_assignments.tours");
    ...
    public void testMultipleMainFunctions() throws  IOException {
        errorList = TestHelper.parseToursFile("src/test/java/tours/examples/typechecker/invalid/invalid_main_function_void.tours");
        assertEquals(1, errorList.size());
        assertEquals("line 1:10 no viable alternative at input 'funcvoidmain'",
                errorList.get(0));

        errorList = TestHelper.parseToursFile("src/test/java/tours/examples/typechecker/invalid/invalid_main_function_return_array.tours");
        assertEquals(1, errorList.size());
        assertEquals("line 1:14 no viable alternative at input 'funcstring[]main'",
                errorList.get(0));

        errorList = TestHelper.parseToursFile("src/test/java/tours/examples/typechecker/invalid/invalid_main_function_return_primitive.tours");
        assertEquals(1, errorList.size());
